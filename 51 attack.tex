...
The cost of attacking such a chain under regular Ethereum PoW protocol is $361$ Ethers. Under HWD-PoW protocol, if an attacker appeared in $1\%$ of pervious blocks, the total cost of performing an attack will be calculated as follow,
\begin{equation}
