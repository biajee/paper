...
The attacker needs to spend hashrate $p_a$ in the original branch for a time duration $t_a$. The optimum spending of $p_a$ is to mine for $w/2$ period and then switch $p_a$ to hidden branch at attack point show in Fig 1. In order for attack to be successful, we have
